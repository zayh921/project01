...
10	向上开始新的一行 (Start New Line )	    ctrl+shift+enter
11	如何查看源码 (class)	ctrl + 选中结构 或   ctrl + shift + t
...
46	快速搜索类中的错误(highlighted error)    	ctrl + shift + q
47	选择要粘贴的内容(Show in Explorer)	    ctrl+shift+v
48	查找方法在哪里被调用(Call Hierarchy)	    ctrl+shift+h
*/
